...
public class AppSettings
{
    ...
    // ---- Dashboard block layout: page id -> ordered block ids ----
    public Dictionary<string, List<string>> BlockOrders { get; set; } = new();
    public Dictionary<string, List<string>> BlockDefaults { get; set; } = new();
